...
public class Attachment {
	...
	public Attachment(SelectionKey _key, ProcessType _processID, SocketChannel _channel, 
			int _buffSize, SelectionKey _oppositeKey, SocketChannel _oppositeChannel) {
